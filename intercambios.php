...
if(!$_GET){
header('location:intercambios.php?pagina=1');
$iduser = $_SESSION['id'];
...
$ruta="photosintercambios";
$ruta = $ruta."/".$nombreimg;
move_uploaded_file($archivo, $ruta);


$query = "INSERT INTO intercambios(iduser,titulo,descripcion,imagen) VALUES ('$iduser','$titulo','$descripcion','".$nombreimg."')";
...
$card_query = "SELECT intercambios.titulo, intercambios.descripcion, intercambios.imagen, usuarios.usuario, detalle_usuarios.nombre, detalle_usuarios.ubicacion FROM intercambios inner join usuarios on intercambios.iduser=usuarios.iduser inner join detalle_usuarios on usuarios.iduser=detalle_usuarios.iduser ORDER BY id_intercambio DESC LIMIT :iniciar,:narticulos ";
...
$card_queryfilas = "SELECT * FROM intercambios";
  ...
  $card_content .= '
     ...
     <div class="col s6 m4 l4 xl4">
        ...
        <div class="card">
          ...
          <img src="photosintercambios/'.$imagen.'" alt="" class="activator"  height="200" width="200">
          </div>
...
require 'views/intercambios.view.php';
?>

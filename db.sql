...
CREATE TABLE usuarios (
	...
	FOREIGN KEY(idtipo) REFERENCES tipouser(idtipo)
);
...
select pais.PAIS, dep.DepName, mun.MunName from pais inner join dep on pais.ID=dep.PAIS_ID inner join mun on dep.DEP_ID=mun.DEP_ID
...
INSERT INTO `dep` (`DEP_ID`, `DepName`, `PAIS_ID`) VALUES
	(1, 'Ahuachapán', 1),
	(2, 'Santa Ana', 1),
	(3, 'Sonsonate', 1),
	(4, 'La Libertad', 1),
...
CREATE TABLE IF NOT EXISTS `mun` (
  `ID` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `MunName` varchar(100) NOT NULL COMMENT 'Nombre del Municipio',
  `DEP_ID` int(11) NOT NULL COMMENT 'Departamento al cual pertenece el municipio',
  FOREIGN KEY(DEP_ID) REFERENCES dep(DEP_ID)
);

INSERT INTO `mun` (`ID`, `MunName`, `DEP_ID`) VALUES
	(1, 'Ahuachapán', 1),
	(2, 'Jujutla', 1),
	(3, 'Atiquizaya', 1),

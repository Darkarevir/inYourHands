...
<script type="text/javascript">
 ...
 <body class="	" >
	...
	<div class="col s12 m12 #ffcdd2 red lighten-4" >
			<h4 class="center col s12 m12">Publicar una donacion <a onclick="Mostrar()" id="nuevo" class="btn-floating ¿waves-effect waves-light green"><i class="material-icons">add</i></a>
...
<div class="row">
<br>
    <ul class="tabs col s12 m12 #ffcdd2 red lighten-4">
    	<li class="tab col s12"><a href="#test1" style="color:#1b5e20">DONACIONES DISPONIBLES</a></li>
	...
	<div class="main row  container section">
				<div class='col s6 l12'>
					<div class='card section'>
						...
						<center><h4>¡No hay ninguna donación disponible!!</h4></center>
						</div>
					</div>
				</div>
			</div>
...
<div class="container">
	...
	<div class="col s12 center #e0f2f1 teal lighten-5">
			...
			<ul class="pagination">
					...
					<li class=""><a href="donaciones.php?pagina=<?php echo $_GET['pagina']-1 ?>"><i class="material-icons">chevron_left</i></a></li>
                    ...
                    <li class="<?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>"><a href="donaciones.php?pagina=<?php echo $i+1; ?>"><?php echo $i+1; ?></a></li>
                    <?php endfor ?>
                    ...
                    <li class="waves-effect"><a href="donaciones.php?pagina=<?php echo $_GET['pagina']+1 ?>"><i class="material-icons">chevron_right</i></a></li>
                    <?php endif; ?>

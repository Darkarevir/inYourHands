...
<div class="cyan darken-1 white-text center">
    <div class="container">
      <div class="section">
        <h3 class="animated slideInDown slow">Tomar vitaminas durante el embarazo reduce el riesgo de autismo..</h3>
        <p class="animated slideInDown slow">De acuerdo con un estudio de la revista de psiquiatría Jama, las madres que tomaron vitaminas durante el embarazo redujeron el riesgo de algún trastorno del desarrollo en el bebé, como el autismo.</p>


        <div class="video-container">
        <iframe width="853" height="480" src="https://www.youtube.com/embed/CEmpYni2wPo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
      </div>
    </div>
  </div>

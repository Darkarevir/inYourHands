...
<?php if ($totalArticulos>0): ?>
	<div class="main row  container section">
		...
		<div class="col s12 cyan darken-1">
			<h3 class="white-text">Foros para la categoria: Familia</h3>
